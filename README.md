...
A roster of 113 original enchantments spanning combat, tools, mobility, mounts, and more. Implemented as data-driven JSON definitions with custom Java handlers where vanilla effect components aren't sufficient.
...
All 113 enchantments are original to Meridian — names, IDs, weights, costs, effect definitions, and description text are authored fresh.
...
- **Enchantment data (113 of 113):** Original to Meridian.
