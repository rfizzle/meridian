...
A roster of 124 original enchantments spanning combat, tools, mobility, mounts, and more. Implemented as data-driven JSON definitions with custom Java handlers where vanilla effect components aren't sufficient.
...
- **Tools** — Excavate (3x3 mining), Prospect (vein mining), Grind (hardness-scaled speed), Adamant (tier boost), Reclaim (drops to inventory), Bounty, Furrow, Terrasculpt
...
All 124 enchantments are original to Meridian — names, IDs, weights, costs, effect definitions, and description text are authored fresh.
...
- **Enchantment data (124 of 124):** Original to Meridian.
