 ...
 */
public final class JeiEnchantmentBrowserCategory implements IRecipeCategory<EnchantmentBrowserRecord> {

    private static final ResourceLocation OVERRIDE_TEXTURE = Meridian.id("textures/gui/enchanting_table.png");

    private final mezz.jei.api.recipe.RecipeType<EnchantmentBrowserRecord> recipeType;
    ...
    public JeiEnchantmentBrowserCategory(mezz.jei.api.recipe.RecipeType<EnchantmentBrowserRecord> recipeType,
        ...
        this.title = title;
        this.icon = icon;
        this.background = guiHelper.createBlankDrawable(144, 26);
        this.overrideIcon = guiHelper.createDrawable(OVERRIDE_TEXTURE, 224, 0, 16, 16);
    }

    @Override
    public mezz.jei.api.recipe.RecipeType<EnchantmentBrowserRecord> getRecipeType() {
        return recipeType;
    }
    ...
    public void draw(EnchantmentBrowserRecord record, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        ...
        guiGraphics.drawString(font, name, 2, 2, 0xFFFFFF);
