...
public class EnchantmentLibraryFeedbackGameTest implements FabricGameTest {
     ...
     */
    @GameTest(template = "meridian:empty_5x5x5", timeoutTicks = TIMEOUT, batch = "meridianLibraryFeedbackDeposit")
     ...
     */
    @GameTest(template = "meridian:empty_5x5x5", timeoutTicks = TIMEOUT, batch = "meridianLibraryFeedbackReject")
