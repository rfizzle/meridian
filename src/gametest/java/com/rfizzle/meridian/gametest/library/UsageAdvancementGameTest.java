...
package com.rfizzle.meridian.gametest.library;
...
public class UsageAdvancementGameTest implements FabricGameTest {
    ...
    @GameTest(template = "meridian:empty_5x5x5", timeoutTicks = TIMEOUT, batch = "meridianAdvDeposit")
    ...
    @GameTest(template = "meridian:empty_5x5x5", timeoutTicks = TIMEOUT, batch = "meridianAdvHopper")
    ...
    @GameTest(template = "meridian:empty_5x5x5", timeoutTicks = TIMEOUT, batch = "meridianAdvExtract")
    ...
    @GameTest(template = "meridian:empty_5x5x5", timeoutTicks = TIMEOUT, batch = "meridianAdvSalvage")
