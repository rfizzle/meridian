 ...
 * material. Three blocks ({@code infused_hellshelf}, {@code infused_seashelf},
 * {@code dormant_deepshelf}) have no unique side texture and reuse their family's base shelf side.
 *
...
public class MeridianModelProvider extends FabricModelProvider {
    ...
    public static Map<Block, ColumnTextures> shelfTextures() {
        ...
        // infused_seashelf has no unique side texture — reuses the base seashelf face.
        map.put(MeridianShelves.INFUSED_SEASHELF, column("seashelf", PRISMARINE_SHELF_TOP));
        // End
