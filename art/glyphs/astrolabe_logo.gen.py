...
lines = ["# Meridian astrolabe hero logo — generated by astrolabe_logo.gen.py", f"size: {N}",
         # Launcher/store art rather than an in-world sprite, so it earns the
         # flat-fill check only. The ladder mints each shipped tier from this
         # one 128px master by integer upscale.
         "kind: icon",
         "ships: art/icon-128.png 128",
         "ships: src/main/resources/assets/meridian/icon.png 256",
