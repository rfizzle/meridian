...
| Remaining shelf + library blocks (≈26 textures) | **MISSING** | `assets/meridian/textures/block/*.png` — sculk shelves + variants, bee/melon/stone, `library/`, `ender_library/`, `filtering_shelf/`, `rectifier*`, sight/treasure shelves. Sourced from Zenith (orig. Apotheosis) per README attribution — not yet glyph-authored |
