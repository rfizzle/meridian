...
126 original enchantments, defined as JSON in `data/meridian/enchantment/` (126 files) on top of vanilla's data-driven `EnchantmentEffectComponents`, with custom Java handlers where vanilla components are insufficient. Names, IDs, weights, costs, and effects are original to Meridian.
